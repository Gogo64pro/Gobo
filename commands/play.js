...
module.exports = {
    ...
    async execute(message,args,alias){
        ...
        const play = async(guild,song) =>{
            ...
            const resource = createAudioResource(stream, {volume: 1, seek: true });
        ...
        if(alias === 'play'){
          ...
          if(ytdl.validateURL(args[0])){
                ...
                song = {title: songInfo.videoDetails.title,url: songInfo.videoDetails.video_url,thumbnail: songInfo.videoDetails.thumbnails[0].url}
            }else{
